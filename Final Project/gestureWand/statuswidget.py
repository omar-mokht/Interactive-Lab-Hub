...
class StatusWidget():
    ...
    def __init__(self, surface, theta, color, text_filepath, x=640, y=360, r=245,
                 r_inner=40, r_outer=62, s_text=70, progress=80):
        ...
        self.r_iconpadding = [0.1, r_inner - 25]
        self.r_progress = [0.1, r_inner - 12] # radius of the circular progress bar
    ...
    def animation_step_update(self):
        if self.theta[CURRENT] > 330 or self.theta[CURRENT] < 30:
            ...
            self.defocus()
        animatable_objects = ['r_inner', 'r_outer', 'r_iconpadding', 'r_progress','size_texticon', 'progress']
    ...
    def focus(self):
        ...
        self.r_iconpadding[EXPECTED] += 20
        self.r_progress[EXPECTED] += 25
